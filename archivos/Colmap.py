...
def main(project_path):
    ...
    run_command("colmap feature_extractor --database_path ./database.db --image_path ./fotos")
    ...
    run_command("colmap mapper --database_path ./database.db --image_path ./fotos --output_path ./sparse")

    # Paso 5: Ejecutar image_undistorter
    print("Ejecutando image_undistorter...")
    run_command("colmap image_undistorter --image_path ./fotos --input_path ./sparse/0 --output_path ./dense --output_type COLMAP")
